...
class AreaUsuarioController extends Controller
{
	 ...
	 * @return AreaUsuario the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=AreaUsuario::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AreaUsuario $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='area-usuario-form')
		{
