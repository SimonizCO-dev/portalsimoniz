...
class EmProdUsuarioController extends Controller
{
	/**
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['EmProdUsuario']))
		{
			$model->attributes=$_POST['EmProdUsuario'];
			$model->Id_Users_Notif = implode(",", $_POST['EmProdUsuario']['Id_Users_Notif']);
	 ...
	 * @return EmProdUsuario the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=EmProdUsuario::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EmProdUsuario $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='em-prod-usuario-form')
		{
