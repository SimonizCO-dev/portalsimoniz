...
$(function() {
  ...
  $("#download").click(function() {
    limp_div_msg();
    window.location =  "<?php echo Yii::app()->getBaseUrl(true).'/files/portal_reportes/plantillas/plantilla_flete_guia.xlsx'; ?>";
  });
  ...
  $("#valida_form").click(function() {
      ...
      if(valid_file == 1){
        ...
        $.ajax({
            url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=ventas/uploadfleteguia'; ?>",  
            type: 'POST',
            // Form data
