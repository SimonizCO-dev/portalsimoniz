...
<div class="row">
    <div class="col-sm-4">
      <div class="form-group">
          ...
          <?php echo $form->numberField($model,'consecutivo', array('class' => 'form-control form-control-sm', 'maxlength' => '50', 'autocomplete' => 'off', 'type' => 'number')); ?>
      </div>
    </div>
</div>
