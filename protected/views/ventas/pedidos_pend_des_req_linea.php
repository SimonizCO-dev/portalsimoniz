...
<h4>Pedidos pendientes por despacho y requisiciones / línea</h4>
...
<div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        ...
        <?php
            ...
            'name'=>'Ventas[linea_inicial]',
            'id'=>'Ventas_linea_inicial',
            'data'=>$lista_lineas,
            'htmlOptions'=>array(),
              'options'=>array(
    ...
    <div class="col-sm-4">
      <div class="form-group">
        ...
        <?php
            $this->widget('ext.select2.ESelect2',array(
            'name'=>'Ventas[linea_final]',
            'id'=>'Ventas_linea_final',
            'data'=>$lista_lineas,
            'htmlOptions'=>array(),
              'options'=>array(
                'placeholder'=>'Seleccione...',
...
function resetfields(){
  ...
  $('#Ventas_linea_inicial').val('').trigger('change');
  $('#Ventas_linea_final').val('').trigger('change');
}
