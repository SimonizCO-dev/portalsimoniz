...
$query= "
SET NOCOUNT ON
EXEC P_PR_COM_VT_NOTAS_NAC_FECH
    @FECHA1 = N'".$FechaM1."',
    @FECHA2 = N'".$FechaM2."'
";
...
if($opcion == 1){
  ...
  class PDF extends FPDF{
    ...
    function Header(){
      ...
      $this->Cell(200,5,utf8_decode('NOTAS CRÉDITO'),0,0,'L');
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Consulta_notas_credito_'.date('Y_m_d_H_i_s').'.pdf');
}
...
if($opcion == 2){
  ...
  $n = 'Consulta_notas_credito_'.date('Y_m_d_H_i_s');
