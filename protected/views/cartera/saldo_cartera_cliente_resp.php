...
$c_inicial = $model['cliente_inicial'];
$c_final = $model['cliente_final'];

$rep = new Reporte;
$cliente_inicial = $rep->RazonSocialCliente($c_inicial);
$cliente_final = $rep->RazonSocialCliente($c_final);
...
$query ="
  EXEC P_PR_FIN_CT_SALD_CART_CLIENTE
...
/*fin configuración array de datos*/
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Saldo_cartera_cliente_'.date('Y_m_d_H_i_s').'.pdf');
