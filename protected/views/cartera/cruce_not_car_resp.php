...
if($opcion == 1){
  ...
  class PDF extends FPDF{
    ...
    function Header(){
      ...
      $this->Cell(200,5,'CRUCE NOTAS CARTERA',0,0,'L');
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Cruce_notas_cartera_'.date('Y_m_d_H_i_s').'.pdf');
...
if($opcion == 2){
  ...
  $n = 'Cruce_notas_cartera_'.date('Y_m_d_H_i_s');
