	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->numberField($model,'Id_Usuario', array('class' => 'form-control form-control-sm', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Nombres'); ?>
			    <?php echo $form->textField($model,'Nombres', array('class' => 'form-control form-control-sm', 'autocomplete' => 'off')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->textField($model,'Usuario', array('class' => 'form-control form-control-sm', 'autocomplete' => 'off')); ?>
	        </div>
	    </div>
	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Usuario[Id_Usuario_Creacion]',
						'id'=>'Usuario_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Usuario[Id_Usuario_Actualizacion]',
						'id'=>'Usuario_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	...
	<div class="row">
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php 
                	$array_orden = array(1 => 'ID ASC', 2 => 'ID DESC', 3 => 'Usuario ASC', 4 => 'Usuario DESC', 5 => 'Nombres ASC', 6 => 'Nombres DESC', 7 => 'Correo ASC', 8 => 'Correo DESC', 9 => 'Usuario que creo ASC', 10 => 'Usuario que creo DESC', 11 => 'Fecha de creación ASC', 12 => 'Fecha de creación DESC', 13 => 'Ultimo usuario que actualizó ASC', 14 => 'Ultimo usuario que actualizó DESC', 15 => 'Ultima fecha de actualización ASC', 16 => 'Ultima fecha de actualización DESC', 17 => 'Estado ASC', 18 => 'Estado DESC',
                	);
            	?>
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Usuario[orderby]',
						'id'=>'Usuario_orderby',
						'data'=>$array_orden,
						'htmlOptions'=>array(),
					  	'options'=>array(
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#Usuario_Correo').val('');
		$('#Usuario_Usuario').val('');
		$('#Usuario_Id_Usuario_Creacion').val('').trigger('change');
		$('#Usuario_Fecha_Creacion').val('');
		$('#Usuario_Id_Usuario_Actualizacion').val('').trigger('change');
