...
<div class="row mb-2">
    <div class="col-sm-6">
        <h4>Administración porcentajes cumplimiento</h4>
    </div>
    <div class="col-sm-6 text-right">  
        <button type="button" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=cptjcump/create'; ?>';"><i class="fa fa-plus"></i> Nuevo registro</button>
