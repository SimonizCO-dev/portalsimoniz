...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="form-group">
            <?php echo $form->error($model,'CUM_INICIAL', array('class' => 'badge badge-warning float-right')); ?>
    ...
    <div class="col-sm-3">
        <div class="form-group">
            <?php echo $form->error($model,'CUM_FINAL', array('class' => 'badge badge-warning float-right')); ?>
...
<div class="row mb-2">
    <div class="col-sm-6">  
        <button type="button" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=cptjcump/admin'; ?>';"><i class="fa fa-reply"></i> Volver</button>
