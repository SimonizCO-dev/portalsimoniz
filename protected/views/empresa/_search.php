	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->numberField($model,'Id_Empresa', array('class' => 'form-control form-control-sm', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Empresa[Id_Usuario_Creacion]',
						'id'=>'Empresa_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Empresa[Id_Usuario_Actualizacion]',
						'id'=>'Empresa_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#Empresa_Id_Empresa').val('');
		$('#Empresa_Descripcion').val('');
		$('#Empresa_Id_Usuario_Creacion').val('').trigger('change');
		$('#Empresa_Fecha_Creacion').val('');
		$('#Empresa_Id_Usuario_Actualizacion').val('').trigger('change');
		$('#Empresa_Fecha_Actualizacion').val('');
		$('#Empresa_Estado').val('').trigger('change');
		$('#Empresa_orderby').val('').trigger('change');
