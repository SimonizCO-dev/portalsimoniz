...
<div class="row">
    <div class="col-sm-4">
    	<div class="form-group">
		    ...
		    <?php echo $form->textField($model,'Proveedor', array('class' => 'form-control form-control-sm', 'maxlength' => '300', 'autocomplete' => 'off', 'onkeyup' => 'convert_may(this)')); ?>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            <?php echo $form->label($model,'Tel', array('class' => 'control-label')); ?>
            <?php echo $form->error($model,'Tel', array('class' => 'badge badge-warning float-right')); ?>
            <?php echo $form->textField($model,'Tel', array('class' => 'form-control form-control-sm', 'maxlength' => '200', 'autocomplete' => 'off', 'onkeyup' => 'convert_may(this)')); ?>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
...
<div class="row mb-2">
    <div class="col-sm-6">  
        <button type="button" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=paproveedor/admin'; ?>';"><i class="fa fa-reply"></i> Volver</button>
