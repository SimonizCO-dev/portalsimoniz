...
<h4>Soportes equipos / licencias</h4>
          ...
          <?php
              $this->widget('ext.select2.ESelect2', array(
                  ...
                  'options'  => array(
                      ...
                      'formatInputTooShort' =>  'js:function(){ return "Digite más de 3 caracteres para iniciar busqueda <button type=\"button\" class=\"btn btn-primary btn-xs float-right\" onclick=\"clear_select2_ajax(\'Reporte_equipo\')\">Limpiar campo</button>"; }',
                  ),
              ));
          ?>
      </div>
...
<div class="row" id="div_inc_lic" style="display: none;">
  <div class="col-sm-12">
  	<div class="form-group">
      <?php echo $form->error($model,'inc_lic', array('class' => 'badge badge-warning float-right')); ?>
      <?php echo $form->label($model,'inc_lic'); ?>
      <?php
          $this->widget('ext.select2.ESelect2',array(
              'name'=>'ReportePa[inc_lic]',
              'id'=>'ReportePa_inc_lic',
...
$(function() {
  ...
  $('#ReportePa_opc').change(function(){
    ...
    $('#div_inc_lic').hide();
    $('#ReportePa_inc_lic').val('').trigger('change');
  ...
  $('#ReportePa_inc_lic').change(function(){
    if(this.value != ""){
      $('#ReportePa_inc_lic_em_').html('');
      $('#ReportePa_inc_lic_em_').hide(); 
    }
  });
  ...
  $("#valida_form").click(function() {
      ...
      $.fn.yiiactiveform.validate(form, function(messages) {
        if($.isEmptyObject(messages)) {
          ...
          var inc_lic = $('#ReportePa_inc_lic').val();
          ...
          if(opc == 1){
            ...
            if(serial == "" ||  inc_lic == ""){
              ...
              if(inc_lic == ""){
                $('#ReportePa_inc_lic_em_').html('Incluir licencia(s) es requerido.');
                $('#ReportePa_inc_lic_em_').show(); 
              }
              ...
              $('#ReportePa_inc_lic :selected').each(function(i, sel){ 
                  cad_inc_lic += $(sel).val()+','; 
              });
          ...
          if($valid == 1){
            ...
            $.ajax({ 
              type: "POST", 
              url: "<?php echo Yii::app()->createUrl('reportepa/soportesequipo'); ?>",
              data: data,
              dataType: "json",
              beforeSend: function(){
