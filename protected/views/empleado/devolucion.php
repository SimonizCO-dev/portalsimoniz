...
<p>
Busque por # identificación, nombres o apellidos (Recuerde que el empleado debe contar con un contrato activo y tener elementos y/o herramientas en estado: ASIGNADO):
</p>
            ...
            <?php
                $this->widget('ext.select2.ESelect2', array(
                    ...
                    'options'  => array(
                        ...
                        'language' => 'es',
                        'ajax' => array(
                            'url' => Yii::app()->createUrl('empleado/SearchEmpleadoDev'),
                            'dataType'=>'json',
