...
<script type="text/javascript">
	$(function() {
		...
		$('#Empleado_Id_Com_Fam').val(<?php echo $json_cf_act ?>).trigger('change');
		$('#Empleado_Id_Ocupacion').val(<?php echo $json_ocup_act ?>).trigger('change');

		//se calcula la edad al cargar dom

    	var fn = $("#Empleado_Fecha_Nacimiento").val();

    	if(fn != ""){
	        $("#Empleado_edad").val(calcularEdad(fn));
	    }

    	var ciudad_res = parseInt($('#Empleado_Id_Ciudad_Residencia').val());
    	...
    	var alergia = $("#Empleado_Alergia").val();
    	...
    	var genero = $("#Empleado_Id_Genero").val();
