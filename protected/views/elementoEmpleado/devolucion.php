...
<h4>Devolución de elementos / herramientas por empleado</h4>
...
<div class="row mb-2" id="buttons">
    <div class="col-sm-6">  
        <button type="button" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=empleado/devolucion' ?>';"><i class="fa fa-reply"></i> Volver</button>

        <button type="submit" class="btn btn-primary btn-sm" onclick="return valida_opciones(event);" id="btn_submit" style="display: none;"><i class="fas fa-save"></i> Devolver item(s) selecionado(s)</button>
    </div>
</div>
