...
$query= "
    SET NOCOUNT ON
    EXEC P_PR_COM_ACUM_VT_LN_EST_TIP_SUM
    @OPT = ".$opc.",
    @VAR1 = N'".$linea."',
...
if($opcion == 1){
  ...
  class PDF extends FPDF{
    ...
    function Header(){
      ...
      $this->Cell(200,5,utf8_decode('CONTROL DE PEDIDOS ACUMULADO / LÍNEA TOTALIZADO'),0,0,'L');
      ...
      $this->Cell(11,2,utf8_decode('CANT.'),0,0,'R');
      $this->Cell(11,2,utf8_decode('VLR.'),0,0,'R');
      ...
      foreach ($array_titulos as $llave => $valor) {
        $this->Cell(11,2,utf8_decode(''),0,0,'R');
      }

      $this->Cell(11,2,utf8_decode('TOTAL'),0,0,'R');
      $this->Cell(11,2,utf8_decode('TOTAL'),0,0,'R');
    ...
    function Tabla(){
      ...
      foreach ($query1 as $reg1) {
        ...
        $this->Cell(11,3,number_format(($MES12),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES11),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES10),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES9),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES8),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES7),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES6),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES5),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES4),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES3),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES2),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($MES1),0,".",","),0,0,'R');

        $this->Cell(11,3,number_format(($CI_CAN),0,".",","),0,0,'R');
        $this->Cell(11,3,number_format(($CI_VAL),0,".",","),0,0,'R');
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Control_pedidos_acumulado_linea_tot_'.date('Y_m_d_H_i_s').'.pdf');
}
...
if($opcion == 2){
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1', $array_titulo_meses[0]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G1', $array_titulo_meses[1]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H1', $array_titulo_meses[2]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I1', $array_titulo_meses[3]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J1', $array_titulo_meses[4]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K1', $array_titulo_meses[5]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', $array_titulo_meses[6]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', $array_titulo_meses[7]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1', $array_titulo_meses[8]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1', $array_titulo_meses[9]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P1', $array_titulo_meses[10]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', $array_titulo_meses[11]);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', 'CANT. TOTAL');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', 'VLR. TOTAL');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', 'PROM. VENTAS');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', 'STOCK MESES');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', 'BASE PEDIDOS');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W1', 'EXIST. A LA FECHA');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X1', 'O.C PEND.');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y1', 'A.D PEDIR');
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z1', '# DÍAS CUBRIM.');

  $objPHPExcel->getActiveSheet(0)->getStyle('A1:Z1')->getAlignment()->setHorizontal($alignment_center);
  ...
  foreach ($query1 as $reg1) {
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F'.$Fila, $MES12);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$Fila, $MES11);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H'.$Fila, $MES10);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$Fila, $MES9);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J'.$Fila, $MES8);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K'.$Fila, $MES7);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$Fila, $MES6);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$Fila, $MES5);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('N'.$Fila, $MES4);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$Fila, $MES3);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P'.$Fila, $MES2);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q'.$Fila, $MES1);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('R'.$Fila, $CI_CAN);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('S'.$Fila, $CI_VAL);
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('V'.$Fila, $BASE_PEDIDOS);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W'.$Fila, $EXIST_FECHA);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.$Fila, $O_C_PEND);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y'.$Fila, $AD_PEDIR);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.$Fila, $DIAS_CUB);

    $objPHPExcel->getActiveSheet(0)->getStyle('A'.$Fila.':D'.$Fila)->getAlignment()->setHorizontal($alignment_left);
    $objPHPExcel->getActiveSheet(0)->getStyle('E'.$Fila.':S'.$Fila)->getNumberFormat()->setFormatCode('0'); 
    $objPHPExcel->getActiveSheet(0)->getStyle('T'.$Fila.':Z'.$Fila)->getNumberFormat()->setFormatCode('#,#0.0');
    $objPHPExcel->getActiveSheet(0)->getStyle('E'.$Fila.':Z'.$Fila)->getAlignment()->setHorizontal($alignment_right);
  ...
  $n = 'Control_pedidos_acumulado_linea_tot_'.date('Y_m_d_H_i_s');
