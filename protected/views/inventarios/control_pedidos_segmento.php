...
<h4>Control de pedidos por segmento</h4>
...
<div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        <?php echo $form->error($model,'segmento', array('class' => 'badge badge-warning float-right')); ?>
        <?php echo $form->label($model,'segmento'); ?>
        <?php
            $this->widget('ext.select2.ESelect2',array(
            'name'=>'Inventarios[segmento]',
            'id'=>'Inventarios_segmento',
            'data'=>$lista_segmentos,
            'htmlOptions'=>array(),
              'options'=>array(
...
function resetfields(){
  $('#Inventarios_segmento').val('').trigger('change');
