...
if($opcion == 1){
  ...
  class PDF extends FPDF{
    ...
    function Header(){
      ...
      $this->Cell(100,5,utf8_decode('CONTROL DE PEDIDOS POR LÍNEA'),0,0,'L');
  ...
  $pdf->Tabla();
  ob_end_clean();
  $pdf->Output('D','Control_pedidos_linea_'.date('Y_m_d_H_i_s').'.pdf');
}
...
if($opcion == 2){
  ...
  $n = 'Control_pedidos_linea_'.date('Y_m_d_H_i_s');
