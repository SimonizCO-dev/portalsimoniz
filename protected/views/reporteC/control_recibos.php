...
$(function() {
  ...
  $("#ReporteC_fecha_inicial").datepicker({
    ...
    $('#ReporteC_fecha_final').datepicker('setStartDate', minDate);
    $('#ReporteC_fecha_final').datepicker('setEndDate', maxDate);
  });

  $("#ReporteC_fecha_final").datepicker({
      language: 'es',
      autoclose: true,
      orientation: "right bottom",
  }).on('changeDate', function (selected) {
    ...
    $('#ReporteC_fecha_inicial').datepicker('setEndDate', maxDate);
  });
...
function reporte_pantalla(){
  ...
  var fecha_final = $("#ReporteC_fecha_final").val();

  var data = {fecha_inicial: fecha_inicial, fecha_final: fecha_final}
  $(".ajax-loader").fadeIn('fast');
  $.ajax({ 
    type: "POST", 
    url: "<?php echo Yii::app()->createUrl('reportec/controlrecibospant'); ?>",
    data: data,
...
function resetfields(){
  $(".ajax-loader").fadeIn('fast');
  $("#resultados").html('');
  $('#ReporteC_fecha_inicial').val('');
  $('#ReporteC_fecha_inicial').datepicker('setStartDate', '');
  $('#ReporteC_fecha_inicial').datepicker('setEndDate', '');
  $('#ReporteC_fecha_final').val('');
  $('#ReporteC_fecha_final').datepicker('setStartDate', '');
  $('#ReporteC_fecha_final').datepicker('setEndDate', '');
  $(".ajax-loader").fadeOut('fast');
}
