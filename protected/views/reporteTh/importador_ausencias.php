...
$(function() {
  ...
  $("#download").click(function() {
    ...
    $("#mensaje").html('');
    window.location =  "<?php echo Yii::app()->getBaseUrl(true).'/files/talento_humano/plantillas/plantilla_ausencia.xlsx'; ?>";
  });
  ...
  $("#valida_form").click(function() {
      ...
      if(valid_file == 1){
        ...
        $.ajax({
            url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=reporteth/uploadausencias'; ?>",  
            type: 'POST',
            // Form data
