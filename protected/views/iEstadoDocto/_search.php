	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'IEstadoDocto[Id_Usuario_Creacion]',
						'id'=>'IEstadoDocto_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'IEstadoDocto[Id_Usuario_Actualizacion]',
						'id'=>'IEstadoDocto_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	...
	<div class="row">
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'IEstadoDocto[orderby]',
						'id'=>'IEstadoDocto_orderby',
						'data'=>$array_orden,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    	...
	    	<div class="form-group">
	          	<?php 
					$this->widget('application.extensions.PageSize.PageSize', array(
				        'mGridId' => 'iestado-docto-grid', //Gridview id
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#IEstadoDocto_Id').val('');
		$('#IEstadoDocto_Descripcion').val('');
		$('#IEstadoDocto_Id_Usuario_Creacion').val('').trigger('change');
		$('#IEstadoDocto_Fecha_Creacion').val('');
		$('#IEstadoDocto_Id_Usuario_Actualizacion').val('').trigger('change');
		$('#IEstadoDocto_Fecha_Actualizacion').val('');
		$('#IEstadoDocto_Estado').val('').trigger('change');
		$('#IEstadoDocto_orderby').val('').trigger('change');
