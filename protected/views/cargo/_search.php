	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->numberField($model,'Id_Cargo', array('class' => 'form-control form-control-sm', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Cargo'); ?>
			    <?php echo $form->textField($model,'Cargo', array('class' => 'form-control form-control-sm', 'autocomplete' => 'off')); ?>
	        </div>
	    </div>
	</div>
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Cargo[Id_Usuario_Creacion]',
						'id'=>'Cargo_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'Cargo[Id_Usuario_Actualizacion]',
						'id'=>'Cargo_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#Cargo_Id_Cargo').val('');
		$('#Cargo_Cargo').val('');
		$('#Cargo_Id_Usuario_Creacion').val('').trigger('change');
		$('#Cargo_Fecha_Creacion').val('');
		$('#Cargo_Id_Usuario_Actualizacion').val('').trigger('change');
