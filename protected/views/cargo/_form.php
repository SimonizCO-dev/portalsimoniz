...
<div class="row">
    <div class="col-sm-4">
    	<div class="form-group">
		    ...
		    <?php echo $form->textField($model,'Cargo', array('class' => 'form-control form-control-sm', 'maxlength' => '100', 'autocomplete' => 'off', 'onkeyup' => 'convert_may(this)')); ?>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
...
<div class="row mb-2">
    <div class="col-sm-6">  
        <button type="button" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=cargo/admin'; ?>';"><i class="fa fa-reply"></i> Volver</button>
