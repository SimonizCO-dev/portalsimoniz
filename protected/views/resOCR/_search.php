	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ResOCR[Id_Usuario_Creacion]',
						'id'=>'ResOCR_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ResOCR[Id_Usuario_Actualizacion]',
						'id'=>'ResOCR_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#ResOCR_Id_Usuario_Creacion').val('').trigger('change');
		$('#ResOCR_Fecha_Creacion').val('');
		$('#ResOCR_Id_Usuario_Actualizacion').val('').trigger('change');
