...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <?php echo $form->label($model,'Id_Parentesco', array('class' => 'control-label')); ?>
            <?php echo $form->error($model,'Id_Parentesco', array('class' => 'badge badge-warning float-right')); ?>
            <?php
...
<div class="row">
    ...
    <div class="col-sm-4">
    	<div class="form-group">
    		<?php echo $form->label($model,'Nombre_Apellido', array('class' => 'control-label')); ?>
            <?php echo $form->error($model,'Nombre_Apellido', array('class' => 'badge badge-warning float-right')); ?>
		    <?php echo $form->textField($model,'Nombre_Apellido', array('class' => 'form-control form-control-sm', 'maxlength' => '200', 'autocomplete' => 'off', 'onkeyup' => 'convert_may(this)')); ?>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
