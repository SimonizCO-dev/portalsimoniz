	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'IBodega[Id_Usuario_Creacion]',
						'id'=>'IBodega_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'IBodega[Id_Usuario_Actualizacion]',
						'id'=>'IBodega_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#IBodega_Id_Usuario_Creacion').val('').trigger('change');
		$('#IBodega_Fecha_Creacion').val('');
		$('#IBodega_Id_Usuario_Actualizacion').val('').trigger('change');
		$('#IBodega_Fecha_Actualizacion').val('');
		$('#IBodega_Estado').val('').trigger('change');
		$('#IBodega_orderby').val('').trigger('change');
		$('#ibodega-grid').yiiGridView('update', {
