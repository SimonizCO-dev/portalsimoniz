	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ILinea[Id_Usuario_Creacion]',
						'id'=>'ILinea_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ILinea[Id_Usuario_Actualizacion]',
						'id'=>'ILinea_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    	...
	    	<div class="form-group">
	          	<?php 
					$this->widget('application.extensions.PageSize.PageSize', array(
				        'mGridId' => 'ilinea-grid', //Gridview id
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#ILinea_Id').val('');
		$('#ILinea_Descripcion').val('');
		$('#ILinea_Id_Usuario_Creacion').val('').trigger('change');
		$('#ILinea_Fecha_Creacion').val('');
		$('#ILinea_Id_Usuario_Actualizacion').val('').trigger('change');
		$('#ILinea_Fecha_Actualizacion').val('');
		$('#ILinea_Estado').val('').trigger('change');
		$('#ILinea_orderby').val('').trigger('change');
