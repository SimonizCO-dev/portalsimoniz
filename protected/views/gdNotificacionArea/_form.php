...
<div class="row">
  	<div class="col-sm-4">
    	<div class="form-group">
	      	<?php echo $form->label($model,'Estado_Notif', array('class' => 'control-label')); ?>
	      	<?php echo $form->error($model,'Estado_Notif', array('class' => 'badge badge-warning float-right')); ?>
...
<div class="row mb-2">
    <div class="col-sm-6">  
        <button type="button" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=gdnotificacionarea/admin'; ?>';"><i class="fa fa-reply"></i> Volver</button>
