	...
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITipoTercero[Id_Usuario_Creacion]',
						'id'=>'ITipoTercero_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITipoTercero[Id_Usuario_Actualizacion]',
						'id'=>'ITipoTercero_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITipoTercero[Estado]',
						'id'=>'ITipoTercero_Estado',
						'data'=>$estados,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'ITipoTercero[orderby]',
						'id'=>'ITipoTercero_orderby',
						'data'=>$array_orden,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    	...
	    	<div class="form-group">
	          	<?php 
					$this->widget('application.extensions.PageSize.PageSize', array(
				        'mGridId' => 'itipo-tercero-grid', //Gridview id
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#ITipoTercero_Id').val('');
		$('#ITipoTercero_Descripcion').val('');
		$('#ITipoTercero_Id_Usuario_Creacion').val('').trigger('change');
		$('#ITipoTercero_Fecha_Creacion').val('');
		$('#ITipoTercero_Id_Usuario_Actualizacion').val('').trigger('change');
		$('#ITipoTercero_Fecha_Actualizacion').val('');
		$('#ITipoTercero_Estado').val('').trigger('change');
		$('#ITipoTercero_orderby').val('').trigger('change');
