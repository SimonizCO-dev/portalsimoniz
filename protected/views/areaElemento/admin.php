...
<div class="row mb-2">
    <div class="col-sm-6">
        <h4>Asignación de áreas / subáreas a elementos</h4>
    </div>
    <div class="col-sm-6 text-right">  
        <button type="button" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=areaelemento/create'; ?>';"><i class="fa fa-plus"></i> Nuevo registro</button>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        array(
            'name'=>'Id_Subarea',
            'value' => '($data->Id_Subarea == "") ? "-" : $data->idsubarea->Subarea',
        ),
        array(
            'name'=>'Id_Area',
