...
<div class="row mb-2">
  ...
  <div class="col-sm-6 text-right">  
    <button type="button" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=gddocumento/docse'; ?>';"><i class="fa fa-reply"></i> Volver </button>
    ...
    <?php if($model->Permite_Descarga == 1){ ?>
        <button type="button" class="btn btn-primary btn-sm" id="download"><i class="fas fa-file-download"></i> Descargar documento </button>
