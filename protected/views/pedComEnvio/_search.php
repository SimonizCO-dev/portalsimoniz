	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'PedComEnvio[Id_Usuario_Creacion]',
						'id'=>'PedComEnvio_Id_Usuario_Creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'PedComEnvio[Id_Usuario_Actualizacion]',
						'id'=>'PedComEnvio_Id_Usuario_Actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    	...
	    	<div class="form-group">
	          	<?php 
					$this->widget('application.extensions.PageSize.PageSize', array(
				        'mGridId' => 'ped-com-envio-grid', //Gridview id
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#PedComEnvio_Id').val('');
		$('#PedComEnvio_Id_Usuario').val('').trigger('change');
		$('#PedComEnvio_Id_Usuario_Creacion').val('').trigger('change');
		$('#PedComEnvio_Fecha_Creacion').val('');
		$('#PedComEnvio_Id_Usuario_Actualizacion').val('').trigger('change');
		$('#PedComEnvio_Fecha_Actualizacion').val('');
