...
$query ="EXEC P_CF_CMS_CONS_CMS_TOT2 @ID = ".$id;
...
if($opc == 2){
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E3', 'FECHA FINAL');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F3', 'BASE RECAUDO');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G3', 'TOTAL RECAUDO');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H3', 'BASE VENTA');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I3', 'TOTAL VENTA');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J3', 'TOTAL CORRERIA');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K3', 'BASE AJUSTE');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L3', 'TOTAL AJUSTE');
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M3', 'TOTAL GENERAL');

    $objPHPExcel->getActiveSheet(0)->getStyle('A3:M3')->getAlignment()->setHorizontal($alignment_center);
    ...
    if(!empty($q1)){
      foreach ($q1 as $reg1) {
        ...
        if($tipo == $reg1['TIPO']){
          ...
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E'.$Fila, $FECHA_FINAL);
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('F'.$Fila, $BASE_RECAUDO);
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$Fila, $RECAUDO);
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('H'.$Fila, $BASE_VENTA);
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$Fila, $VENTA);
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('J'.$Fila, $CORRERIA);
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('K'.$Fila, $BASE_AJUSTE);
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$Fila, $AJUSTE);
          $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$Fila, $TOTAL);

          $objPHPExcel->getActiveSheet(0)->getStyle('A'.$Fila.':E'.$Fila)->getAlignment()->setHorizontal($alignment_left);
          $objPHPExcel->getActiveSheet(0)->getStyle('F'.$Fila.':M'.$Fila)->getNumberFormat()->setFormatCode('#,##0.00');
          $objPHPExcel->getActiveSheet(0)->getStyle('F'.$Fila.':M'.$Fila)->getAlignment()->setHorizontal($alignment_right);
