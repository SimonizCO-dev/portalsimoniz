...
<div class="row mb-2">
    <div class="col-sm-6">
        <h4>Reporte detalle base de comisiones</h4>
    </div>
        ...
        array(
            ...
            'buttons'=>array(
                ...
                'reppdf'=>array(
                    ...
                    'url'=>'Yii::app()->createUrl("cControlCms/genrepliqdet", array("id"=>$data->ID_BASE, "opc" => 1))',
                ...
                'repexcel'=>array(
                    ...
                    'url'=>'Yii::app()->createUrl("cControlCms/genrepliqdet", array("id"=>$data->ID_BASE, "opc" => 2))',
                    'visible'=> '(Yii::app()->user->getState("permiso_act") == true && $data->ESTADO == 1)',
                ),
            )
        ),
