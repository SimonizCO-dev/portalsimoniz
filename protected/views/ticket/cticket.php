	      ...
	      <div class="row text-center" >
	          ...
	          <div class="col-sm-4">
	              <div class="form-group">
	                  <a href="<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=ticket/fticket&id='.$modelticket->Id_Ticket.'&v='.$vista.'&c=1';?>" class="calif">
	          ...
	          <div class="col-sm-4">
	              <div class="form-group">
	                  <a href="<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=ticket/fticket&id='.$modelticket->Id_Ticket.'&v='.$vista.'&c=2';?>" class="calif">
	          ...
	          <div class="col-sm-4">
	              <div class="form-group">
	                  <a href="<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=ticket/fticket&id='.$modelticket->Id_Ticket.'&v='.$vista.'&c=3';?>" class="calif">
