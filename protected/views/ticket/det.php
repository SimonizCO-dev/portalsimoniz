...
<div class="row">
    <div class="col-sm-3">
        <div class="form-group">
            ...
            <p><?php if($model->Fecha_Cierre == ""){ echo "-"; }else{ echo UtilidadesVarias::textofechahora($model->Fecha_Cierre); } ?></p>
        </div>
    </div>
    <div class="col-sm-3">
        <div class="form-group">
            ...
            <p><?php if($model->Fecha_Calificacion == ""){ echo "-"; }else{ echo UtilidadesVarias::textofechahora($model->Fecha_Calificacion); } ?></p>
        </div>
    </div>
    <div class="col-sm-3">
        <div class="form-group">
            ...
            <?php echo $form->error($model,'Calificacion', array('class' => 'badge badge-warning float-right')); ?>
           	<?php echo '<br>'.$model->DescCalif($model->Calificacion); ?>
        </div>
    </div>
</div>
<?php } ?>
