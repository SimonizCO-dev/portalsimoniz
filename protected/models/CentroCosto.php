...
/**
 * This is the model class for table "T_PR_CENTRO_COSTO".
 *
 * The followings are the available columns in table 'T_PR_CENTRO_COSTO':
...
class CentroCosto extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id_C_Costo, Codigo, Centro_Costo, Estado, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Fecha_Creacion, Fecha_Actualizacion, orderby', 'safe', 'on'=>'search'),
		);
	}
