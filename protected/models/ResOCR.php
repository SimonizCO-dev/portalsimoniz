...
/**
 * This is the model class for table "TH_RES_OC_R".
 *
 * The followings are the available columns in table 'TH_RES_OC_R':
 * @property integer $Id
 ...
 */
class ResOCR extends CActiveRecord
{
	public $sop;
	public $orderby;
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id, Tipo, Descripcion, Doc_Soporte, Estado, Fecha_Creacion, Fecha_Actualizacion, Id_Usuario_Creacion, Id_Usuario_Actualizacion, orderby', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ResOCR the static model class
	 */
