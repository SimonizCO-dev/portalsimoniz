...
/**
 * This is the model class for table "T_PR_C_PTJ_CUMPLIMIENTO".
 *
 * The followings are the available columns in table 'T_PR_C_PTJ_CUMPLIMIENTO':
 * @property integer $ROWID
 * @property integer $TIPO
 * @property string $CUM_INICIAL
 * @property string $CUM_FINAL
 ...
 */
class CPtjCump extends CActiveRecord
{
	...
	{
		return 'T_PR_C_PTJ_CUMPLIMIENTO';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('ROWID, TIPO, CUM_INICIAL, CUM_FINAL, PORCENTAJE, ESTADO, ID_USUARIO_CREACION, FECHA_CREACION, ID_USUARIO_ACTUALIZACION, FECHA_ACTUALIZACION', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'ROWID' => 'ID',
			'TIPO' => 'Tipo',
			'CUM_INICIAL' => 'Cump. inicial',
			'CUM_FINAL' => 'Cump. final',
	...
	public function search()
	{
		...
		$criteria->compare('t.CUM_INICIAL',$this->CUM_INICIAL);
		$criteria->compare('t.CUM_FINAL',$this->CUM_FINAL);
	 ...
	 * @return CPtjCump the static model class
	 */
