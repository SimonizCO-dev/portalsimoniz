...
/**
 * This is the model class for table "T_PR_CIUDAD".
 *
 * The followings are the available columns in table 'T_PR_CIUDAD':
...
class Ciudad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id_Ciudad, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Ciudad, Fecha_Creacion, Fecha_Actualizacion, Estado, orderby', 'safe', 'on'=>'search'),
		);
	}
