...
/**
 * This is the model class for table "T_PR_I_ESTADO_DOCTO".
 *
 * The followings are the available columns in table 'T_PR_I_ESTADO_DOCTO':
 * @property integer $Id
 ...
 */
class IEstadoDocto extends CActiveRecord
{
	 ...
	 * @return IEstadoDocto the static model class
	 */
