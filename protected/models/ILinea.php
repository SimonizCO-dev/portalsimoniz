...
/**
 * This is the model class for table "T_PR_I_LINEA".
 *
 * The followings are the available columns in table 'T_PR_I_LINEA':
 * @property integer $Id
 ...
 */
class ILinea extends CActiveRecord
{
	 ...
	 * @return ILinea the static model class
	 */
