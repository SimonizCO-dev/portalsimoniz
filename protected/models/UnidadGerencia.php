...
class UnidadGerencia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id_Unidad_Gerencia, Unidad_Gerencia, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Fecha_Creacion, Fecha_Actualizacion, Estado, orderby', 'safe', 'on'=>'search'),
		);
	}
