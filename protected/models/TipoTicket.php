...
/**
 * This is the model class for table "T_PR_TIPO_TICKET".
 *
 * The followings are the available columns in table 'T_PR_TIPO_TICKET':
...
class TipoTicket extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Id_Grupo, Tipo, Usuarios', 'required','on'=>'create'),
			array('Id_Grupo, Tipo, Usuarios, Estado', 'required','on'=>'update'),
			array('Id_Grupo, Estado, Id_Usuario_Creacion, Id_Usuario_Actualizacion', 'numerical', 'integerOnly'=>true),
			array('Tipo', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Id_Tipo, Id_Grupo, Tipo, Estado, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Fecha_Creacion, Fecha_Actualizacion', 'safe', 'on'=>'search'),
		);
	}
