...
/**
 * This is the model class for table "TH_C_PTJ_VENTAS".
 *
 * The followings are the available columns in table 'TH_C_PTJ_VENTAS':
 ...
 */
class CPtjVentas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ROWID, TIPO, PORCENTAJE, ESTADO, ID_USUARIO_CREACION, FECHA_CREACION, ID_USUARIO_ACTUALIZACION, FECHA_ACTUALIZACION', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CPtjVentas the static model class
	 */
