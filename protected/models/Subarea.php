...
/**
 * This is the model class for table "T_PR_SUBAREA".
 *
 * The followings are the available columns in table 'T_PR_SUBAREA':
...
class Subarea extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id_Subarea, Subarea, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Fecha_Creacion, Fecha_Actualizacion, Estado, orderby', 'safe', 'on'=>'search'),
		);
	}
