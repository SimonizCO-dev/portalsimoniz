...
/**
 * This is the model class for table "T_PR_PA_EMPRESA".
 *
 * The followings are the available columns in table 'T_PR_PA_EMPRESA':
 * @property integer $Id_Pa_Empresa
 ...
 */
class PaEmpresa extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Tipo, Descripcion, Estado', 'required'),
			array('Descripcion','unique'),
			array('Tipo, Id_Usuario_Creacion, Id_Usuario_Actualizacion', 'numerical', 'integerOnly'=>true),
			array('Descripcion', 'length', 'max'=>50),
			array('Fecha_Creacion, Fecha_Actualizacion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Id_Pa_Empresa, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Descripcion, Estado, Fecha_Creacion, Fecha_Actualizacion, Tipo, orderby', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('t.Id_Pa_Empresa',$this->Id_Pa_Empresa);
	    ...
	    if(empty($this->orderby)){
			$criteria->order = 't.Id_Pa_Empresa DESC'; 	
		}else{
			switch ($this->orderby) {
			    case 1:
			        $criteria->order = 't.Id_Pa_Empresa ASC'; 
			        break;
			    case 2:
			        $criteria->order = 't.Id_Pa_Empresa DESC'; 
			        break;
