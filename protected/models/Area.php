...
/**
 * This is the model class for table "T_PR_AREA".
 *
 * The followings are the available columns in table 'T_PR_AREA':
 ...
 * @property Usduario $idUsuarioActualizacion
 */
class Area extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id_Area, Area, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Fecha_Creacion, Fecha_Actualizacion, Estado, orderby', 'safe', 'on'=>'search'),
		);
	}
