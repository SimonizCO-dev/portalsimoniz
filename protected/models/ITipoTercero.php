...
/**
 * This is the model class for table "T_PR_I_TIPO_TERCERO".
 *
 * The followings are the available columns in table 'T_PR_I_TIPO_TERCERO':
 * @property integer $Id
 ...
 */
class ITipoTercero extends CActiveRecord
{
	public $orderby;
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id, Descripcion, Estado, Fecha_Creacion, Fecha_Actualizacion, Id_Usuario_Creacion, Id_Usuario_Actualizacion, orderby', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ITipoTercero the static model class
	 */
