...
/**
 * This is the model class for table "T_PR_I_TIPO_DOCTO".
 *
 * The followings are the available columns in table 'T_PR_I_TIPO_DOCTO':
 * @property integer $Id
 ...
 */
class ITipoDocto extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Tipo, Descripcion, Estado, Id_Usuario_Creacion, Id_Usuario_Actualizacion', 'required'),
			array('Tipo', 'unique'),
			...
			array('Id, Tipo, Descripcion, Estado, Fecha_Creacion, Fecha_Actualizacion, Id_Usuario_Creacion, Id_Usuario_Actualizacion, orderby', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ITipoDocto the static model class
	 */
