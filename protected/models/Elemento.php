...
/**
 * This is the model class for table "T_PR_ELEMENTO".
 *
 * The followings are the available columns in table 'T_PR_ELEMENTO':
...
class Elemento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id_Elemento, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Elemento, Fecha_Creacion, Fecha_Actualizacion, Estado, orderby', 'safe', 'on'=>'search'),
		);
	}
