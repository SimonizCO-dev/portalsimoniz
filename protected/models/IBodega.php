...
/**
 * This is the model class for table "T_PR_I_BODEGA".
 *
 * The followings are the available columns in table 'T_PR_I_BODEGA':
 * @property integer $Id
 ...
 */
class IBodega extends CActiveRecord
{
	 ...
	 * @return IBodega the static model class
	 */
