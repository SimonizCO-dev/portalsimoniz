  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <!-- <li class="nav-item"><a href="<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=ticket/create'; ?>" title="Nuevo ticket / Histórico" class="nav-link menu"><i class="nav-icon fas fa-ticket-alt"></i><p class="text">Nuevo ticket / Histórico</p></a></li> -->
